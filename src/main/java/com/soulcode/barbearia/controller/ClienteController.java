...
public class ClienteController {
  ...
  public String edit(Cliente cliente) {
    try {
      ...
      if (clientOpt.isPresent()) {
        Cliente existingClient = clientOpt.get();
        existingClient.setNome(cliente.getNome());
        existingClient.setEmail(cliente.getEmail());
        existingClient.setDataDeNascimento(cliente.getDataDeNascimento());
        existingClient.setCpf(cliente.getCpf());
